      ...
      <div className="container mx-auto">
        ...
        >
          <Swiper 
            ...
            className="h-[420px] md:max-w-[660px] xl:max-w-none mb-8"
          >
            {
            ...
            <SwiperNavButtons 
              containerStyles="absolute left-0 right-0 bottom-[16rem] w-full max-w-[370px] sm:max-w-[620px] lg:max-w-[960px] xl:max-w-[1320px] 
