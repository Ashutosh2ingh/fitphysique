...
const trainerData = [
  {
    ...
    description: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequuntur, blanditiis.',
    social: [
...
const Team = () => {
  return (
    <section className="py-12 xl:h-[105vh]" id="team">
      <div className="container mx-auto h-full flex flex-col items-center justify-center">
        ...
        <motion.div
          ...
          whileInView={'show'}
          viewport={{ once: false, amount: 0.2 }}
          className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-12 mb-12"
        >
          {
